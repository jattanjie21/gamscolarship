...
import { scholarships } from './seedData.mjs';
...
async function main() {
  ...
  console.log(
    '\nDone. Entries are published only after automatic verification succeeds. ' +
      'Unverified or rejected entries remain hidden.'
  );
}
